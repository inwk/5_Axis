...
def create_cavity_milling(
    ...
    try:
        ...
        _safe_destroy(cavity_milling_builder)
...
def create_surface_contour(
    ...
    try:
        ...
        _safe_destroy(surface_contour_builder)
...
def create_3d_adaptive_roughing(
    ...
    try:
        ...
        _safe_destroy(planar_roughing_builder)
