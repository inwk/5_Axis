...
def _collect_common_inputs(batch: dict, device: torch.device) -> dict:
    ...
    return {
        ...
        "tool_diameter_norm": _to_device(batch.get("tool_diameter_norm"), device),
        ...
        "target_tool_kind": _to_device(batch.get("tool_kind_id"), device),
...
def _compute_octree_loss(
    ...
    octree_outputs = model.forward_octree(
        ...
        tool_kind_id=inputs["target_tool_kind"],
        ...
        tool_diameter_norm=inputs["tool_diameter_norm"],
